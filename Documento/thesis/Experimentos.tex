...
Ya con los datos listos para el algoritmo de clasificación estos se dividen en dos conjuntos, el de entrenamiento y el de prueba, en una primera iteración se probó con 204 imágenes o ejemplos de entrenamiento y 40 de prueba. Primero se experimentó discretizando la pantalla (pintarrón) que observaban los sujetos en 2 secciones de misma longitud, izquierda y derecha. Variando las topologías se obtuvieron los siguientes resultados:
\begin{table}[]
	\centering
	\caption{My caption}
	\label{my-label}
	\begin{tabular}{|l|l|l|}
		...
		2-2       & 0.95       & 0.057077ms \\ \hline
		2-5       & 0.925      & 0.063579ms \\ \hline
		2-10      & 0.85       & 0.10723    \\ \hline
	\end{tabular}
\end{table}