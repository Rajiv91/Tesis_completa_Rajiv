...
\begin{table}[]
	...
	\begin{tabular}{|l|l|l|}
		...
		50-20-50  & 97.5\%     & 0.548939ms \\ \hline
	\end{tabular}
\end{table}\label{tab: tresCapas2}
...
\begin{table}[]
	...
	\end{tabular}
\end{table}\label{tab:tresCapas3}
En \ref{tab:tresCapas3} se puede apreciar que a pesar de haber más neuronas y capas no se alcanzan resultados tan buenos como con dos capas ocultas.